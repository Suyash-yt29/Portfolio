...
const projects = [
  {
    ...
    subtitle: "Live communication with intelligent interaction",
    description: "Designed and developed a communication platform featuring user authentication, private messaging, real-time interactions, chat history management, typing indicators, and intelligent interaction systems.",
    tech: ["Flask", "Socket.IO", "JSON", "JavaScript"],
    github: "https://github.com/Suyash29-source",
    color: "from-blue-500 to-indigo-600",
  },
  {
    title: "Smart Restaurant Transformation Platform",
    subtitle: "AI-driven restaurant workflow concept",
    description: "Concept-driven project focused on transforming traditional restaurant experiences using smart technology, digital workflows, and AI-driven customer interaction systems.",
    tech: ["AI Integration", "Automation", "Workflow Design", "User Experience"],
    github: "https://github.com/Suyash29-source",
    color: "from-emerald-400 to-teal-600",
  },
  {
    title: "Personal AI Assistant",
    subtitle: "Productivity assistant with intelligent workflows",
    description: "Building an AI assistant designed to support productivity, conversation, workflow enhancement, and intelligent interactions.",
    tech: ["AI Systems", "Productivity", "Assistant Workflows"],
    github: "https://github.com/Suyash29-source",
    color: "from-orange-400 to-red-600",
  },
  {
    title: "AI Productivity Workspace",
    subtitle: "Smart tools for higher efficiency",
    description: "A productivity-focused platform concept combining AI assistance, workflow organization, and smart tools to improve user efficiency and digital experience.",
    tech: ["AI + Productivity", "Workflow Design", "Modern UX"],
    github: "https://github.com/Suyash29-source",
